	...
	{ 
		...
		public static double getValue(string var0)
		{
			try
			{
				...
				return (double) HighLevel.convertArray(oService.getMethod("double getValue(string)").call(oArguments).getObject());
			}
		...
		public static bool exists(string var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (bool) HighLevel.convertArray(oService.getMethod("boolean exists(string)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static string validateSBML(string var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (string) HighLevel.convertArray(oService.getMethod("string validateSBML(string)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static string getParamPromotedSBML(string var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (string) HighLevel.convertArray(oService.getMethod("string getParamPromotedSBML(string)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static string getModelName()
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (string) HighLevel.convertArray(oService.getMethod("string getModelName()").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static string getModelId()
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (string) HighLevel.convertArray(oService.getMethod("string getModelId()").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static int getNumFunctionDefinitions()
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (int) HighLevel.convertArray(oService.getMethod("int getNumFunctionDefinitions()").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static int getNumCompartments()
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (int) HighLevel.convertArray(oService.getMethod("int getNumCompartments()").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static int getNumReactions()
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (int) HighLevel.convertArray(oService.getMethod("int getNumReactions()").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static int getNumFloatingSpecies()
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (int) HighLevel.convertArray(oService.getMethod("int getNumFloatingSpecies()").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static int getNumBoundarySpecies()
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (int) HighLevel.convertArray(oService.getMethod("int getNumBoundarySpecies()").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static int getNumGlobalParameters()
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (int) HighLevel.convertArray(oService.getMethod("int getNumGlobalParameters()").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static ArrayList getNthFunctionDefinition(int var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (ArrayList) HighLevel.convertArray(oService.getMethod("{} getNthFunctionDefinition(int)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static ArrayList getNthListOfModifiers(int var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (ArrayList) HighLevel.convertArray(oService.getMethod("{} getNthListOfModifiers(int)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static ArrayList getNthListOfReactants(int var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (ArrayList) HighLevel.convertArray(oService.getMethod("{} getNthListOfReactants(int)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static ArrayList getNthListOfProducts(int var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (ArrayList) HighLevel.convertArray(oService.getMethod("{} getNthListOfProducts(int)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static string getNthCompartmentName(int var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (string) HighLevel.convertArray(oService.getMethod("string getNthCompartmentName(int)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static string getNthCompartmentId(int var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (string) HighLevel.convertArray(oService.getMethod("string getNthCompartmentId(int)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static string getOutsideCompartment(string var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (string) HighLevel.convertArray(oService.getMethod("string getOutsideCompartment(string)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static ArrayList getListOfFloatingSpeciesIds()
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (ArrayList) HighLevel.convertArray(oService.getMethod("{} getListOfFloatingSpeciesIds()").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static ArrayList getListOfFloatingSpecies()
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (ArrayList) HighLevel.convertArray(oService.getMethod("{} getListOfFloatingSpecies()").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static string getNthFloatingSpeciesName(int var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (string) HighLevel.convertArray(oService.getMethod("string getNthFloatingSpeciesName(int)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static string getNthFloatingSpeciesId(int var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (string) HighLevel.convertArray(oService.getMethod("string getNthFloatingSpeciesId(int)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static ArrayList getListOfBoundarySpeciesIds()
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (ArrayList) HighLevel.convertArray(oService.getMethod("{} getListOfBoundarySpeciesIds()").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static ArrayList getListOfBoundarySpecies()
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (ArrayList) HighLevel.convertArray(oService.getMethod("{} getListOfBoundarySpecies()").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static string getNthBoundarySpeciesName(int var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (string) HighLevel.convertArray(oService.getMethod("string getNthBoundarySpeciesName(int)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static string getNthBoundarySpeciesId(int var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (string) HighLevel.convertArray(oService.getMethod("string getNthBoundarySpeciesId(int)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static string getCompartmentIdBySpeciesId(string var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (string) HighLevel.convertArray(oService.getMethod("string getCompartmentIdBySpeciesId(string)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static string getNthFloatingSpeciesCompartmentName(int var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (string) HighLevel.convertArray(oService.getMethod("string getNthFloatingSpeciesCompartmentName(int)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static string getNthBoundarySpeciesCompartmentName(int var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (string) HighLevel.convertArray(oService.getMethod("string getNthBoundarySpeciesCompartmentName(int)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static bool isReactionReversible(int var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (bool) HighLevel.convertArray(oService.getMethod("boolean isReactionReversible(int)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static string getNthReactionName(int var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (string) HighLevel.convertArray(oService.getMethod("string getNthReactionName(int)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static string getNthReactionId(int var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (string) HighLevel.convertArray(oService.getMethod("string getNthReactionId(int)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static int getNumReactants(int var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (int) HighLevel.convertArray(oService.getMethod("int getNumReactants(int)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static int getNumProducts(int var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (int) HighLevel.convertArray(oService.getMethod("int getNumProducts(int)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static string getNthReactantName(int var0,int var1)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (string) HighLevel.convertArray(oService.getMethod("string getNthReactantName(int,int)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static string getNthProductName(int var0,int var1)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (string) HighLevel.convertArray(oService.getMethod("string getNthProductName(int,int)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static string getKineticLaw(int var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (string) HighLevel.convertArray(oService.getMethod("string getKineticLaw(int)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static int getNthReactantStoichiometry(int var0,int var1)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (int) HighLevel.convertArray(oService.getMethod("int getNthReactantStoichiometry(int,int)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static int getNthProductStoichiometry(int var0,int var1)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (int) HighLevel.convertArray(oService.getMethod("int getNthProductStoichiometry(int,int)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static double getNthReactantStoichiometryDouble(int var0,int var1)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (double) HighLevel.convertArray(oService.getMethod("double getNthReactantStoichiometryDouble(int,int)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static double getNthProductStoichiometryDouble(int var0,int var1)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (double) HighLevel.convertArray(oService.getMethod("double getNthProductStoichiometryDouble(int,int)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static ArrayList getListOfParameters()
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (ArrayList) HighLevel.convertArray(oService.getMethod("{} getListOfParameters()").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static int getNumParameters(int var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (int) HighLevel.convertArray(oService.getMethod("int getNumParameters(int)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static string getNthParameterName(int var0,int var1)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (string) HighLevel.convertArray(oService.getMethod("string getNthParameterName(int,int)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static string getNthParameterId(int var0,int var1)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (string) HighLevel.convertArray(oService.getMethod("string getNthParameterId(int,int)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static double getNthParameterValue(int var0,int var1)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (double) HighLevel.convertArray(oService.getMethod("double getNthParameterValue(int,int)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static bool getNthParameterHasValue(int var0,int var1)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (bool) HighLevel.convertArray(oService.getMethod("boolean getNthParameterHasValue(int,int)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static string getNthGlobalParameterName(int var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (string) HighLevel.convertArray(oService.getMethod("string getNthGlobalParameterName(int)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static string getNthGlobalParameterId(int var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (string) HighLevel.convertArray(oService.getMethod("string getNthGlobalParameterId(int)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static int getNumRules()
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (int) HighLevel.convertArray(oService.getMethod("int getNumRules()").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static string getNthRule(int var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (string) HighLevel.convertArray(oService.getMethod("string getNthRule(int)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static string getNthRuleType(int var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (string) HighLevel.convertArray(oService.getMethod("string getNthRuleType(int)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static int getNumEvents()
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (int) HighLevel.convertArray(oService.getMethod("int getNumEvents()").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static ArrayList getNthEvent(int var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (ArrayList) HighLevel.convertArray(oService.getMethod("{} getNthEvent(int)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static bool hasValue(string var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (bool) HighLevel.convertArray(oService.getMethod("boolean hasValue(string)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static string[] getBuiltinFunctionInfo(string var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (string[]) HighLevel.convertArray(oService.getMethod("string[] getBuiltinFunctionInfo(string)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static string[] getBuiltinFunctions()
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (string[]) HighLevel.convertArray(oService.getMethod("string[] getBuiltinFunctions()").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static string convertMathMLToString(string var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (string) HighLevel.convertArray(oService.getMethod("string convertMathMLToString(string)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static string convertStringToMathML(string var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (string) HighLevel.convertArray(oService.getMethod("string convertStringToMathML(string)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static string convertLevel1ToLevel2Impl(string var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (string) HighLevel.convertArray(oService.getMethod("string convertLevel1ToLevel2Impl(string)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static string convertLevel2ToLevel1Impl(string var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (string) HighLevel.convertArray(oService.getMethod("string convertLevel2ToLevel1Impl(string)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static string convertPowImpl(string var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (string) HighLevel.convertArray(oService.getMethod("string convertPowImpl(string)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static bool hasInitialAmount(string var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (bool) HighLevel.convertArray(oService.getMethod("boolean hasInitialAmount(string)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static bool hasInitialConcentration(string var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (bool) HighLevel.convertArray(oService.getMethod("boolean hasInitialConcentration(string)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static string addMissingModifiers(string var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (string) HighLevel.convertArray(oService.getMethod("string addMissingModifiers(string)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static string validateWithConsistency(string var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (string) HighLevel.convertArray(oService.getMethod("string validateWithConsistency(string)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static int getSBOTerm(string var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (int) HighLevel.convertArray(oService.getMethod("int getSBOTerm(string)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static bool hasSBOTerm(string var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (bool) HighLevel.convertArray(oService.getMethod("boolean hasSBOTerm(string)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static string getAnnotation(string var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (string) HighLevel.convertArray(oService.getMethod("string getAnnotation(string)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static string getNotes(string var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (string) HighLevel.convertArray(oService.getMethod("string getNotes(string)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static string convertSBML(string var0, int var1, int var2)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (string) HighLevel.convertArray(oService.getMethod("string convertSBML(string, int, int)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static string convertTime(string var0, string var1)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (string) HighLevel.convertArray(oService.getMethod("string convertTime(string, string)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static bool isConstantImpl(string var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (bool) HighLevel.convertArray(oService.getMethod("boolean isConstantImpl(string)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static int checkConsistency()
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (int) HighLevel.convertArray(oService.getMethod("int checkConsistency()").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static int getNumErrors()
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (int) HighLevel.convertArray(oService.getMethod("int getNumErrors()").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		///<summary>
		///This returns the n'th (zero based and < getNumErrors()) Error as List: {string severity, int lineNumber, int columnNumber, int errorCode, string errorMessage}
		///</summary>
		[System.Diagnostics.DebuggerStepThrough(), System.Diagnostics.DebuggerHidden()]
		public static ArrayList getNthError(int var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (ArrayList) HighLevel.convertArray(oService.getMethod("{} getNthError(int)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static ArrayList getListOfErrors()
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (ArrayList) HighLevel.convertArray(oService.getMethod("{} getListOfErrors()").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
		...
		public static ArrayList getDerivedUnitDefinition(string var0)
		{
			try
			{
				...
				Module oModule = new Module("edu.caltech.NOMClipboard");
				Service oService = oModule.getService("NOM");
				return (ArrayList) HighLevel.convertArray(oService.getMethod("{} getDerivedUnitDefinition(string)").call(oArguments).getObject());
			}
			catch(SBWException e) 
			{
				throw e;}
