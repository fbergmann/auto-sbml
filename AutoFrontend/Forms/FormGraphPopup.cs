...
namespace AutoFrontend.Forms
{
	...
	/// </summary>
	public class FormGraphPopup : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.Button cmdSetupGraph;
		/// <summary>
		...
		FormChangeTimeCoursePlot _ChangeTimeCoursePlot = null;
		...
		{
			ColorSymbolRotator oRotator = new ColorSymbolRotator();
			zedGraphControl1.GraphPane.CurveList.Clear();
            zedGraphControl1.IsAntiAlias = _ChangeTimeCoursePlot.IsAntiAlias;

			ArrayList oColumnNames = new ArrayList(_ChangeTimeCoursePlot.XAxisValues);
			...
			PointPairList[] oLists = new PointPairList[numCurves];
			...
			for (int i = 0; i < numCurves; i++)
			{
				...
				zedGraphControl1.GraphPane.AddCurve((string)oColumnNames[nIndex], oLists[i], oRotator.NextColor, SymbolType.None );
				nIndex++;
			}
		...
		private void cmdSetupGraph_Click(object sender, System.EventArgs e)
		{
