...
namespace AutoFrontend.Forms
{
	...
	/// </summary>
	public class FormSelectVariables : System.Windows.Forms.Form
	{
		/// <summary>
		...
		private AutoFrontend.Controls.SelectControl ctrlVariables;
		private AutoFrontend.Controls.SelectControl ctrlParameters;
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(FormSelectVariables));
		...
		private void FormSelectVariables_Closing(object sender, System.ComponentModel.CancelEventArgs e)
		{
			e.Cancel = true;
			Hide();
		}
		...
		public int[] SelectedVariableIndices
		{
			get 
			{
				...
				int[] oResult = new int[selectedItems.Count];
		...
		public int[] SelectedParameters
		{
			...
			{
				int nBoundary = Simulator.getNumberOfBoundarySpecies();
				int[] oResult = new int[NumSelectedParameters];
		...
		public int[] SelectedBoundarySpecies
		{
			get
			{
				...
				int[] oResult = new int[numSelectedBoundaries];
				int[] selectedIndices = ctrlParameters.SelectedIndices;
